...
define('UPLOADFILEPATH', $_SERVER['DOCUMENT_ROOT'] . '/riding/public/uploads/');
define('UPLOADPATH', $_SERVER['DOCUMENT_ROOT'] .'/riding/public/uploads/');
define("SITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/riding/public/');
